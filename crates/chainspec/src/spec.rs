...
/// The Moonchain HUDSON spec
pub static MOONCHAIN_HUDSON: Lazy<Arc<ChainSpec>> = Lazy::new(|| {
    ChainSpec {
        chain: 177888.into(),
        genesis_hash: None,
        paris_block_and_final_difficulty: None,
...
impl ChainSpec {
    ...
    /// Returns `true` if this is a Taiko/Moonchain chain.
    #[inline]
    pub fn is_taiko(&self) -> bool {
        let id = self.chain.id();
        (id >= 167000 && id <= 168000) || (id == 177888) || (id == 999888)
    }
